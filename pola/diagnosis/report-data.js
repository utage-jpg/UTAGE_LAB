...
<p class="rpt-text">あなたが「積極的」に動けるのは、自信があるからではありません。その積極性の裏には、<strong>「動かなければ愛を確かめられない」という衝動</strong>があります。行動することで不安を管理しているのです。これは非常に重要な認識です。多くのロマンハンタータイプの人が「自分は自信家だ」と思っていますが、実態はその逆——アクションは自信ではなく、不安の表れなのです。</p>
...
<p class="rpt-text">この「少し分からない」という不確実性こそが、あなたの恋愛エンジンに火をつけます。確信が持てないから、より深く観察し、より強く動こうとする。<strong>追いかけること自体が、あなたにとっての「生きている感覚」</strong>になっているのです。</p>
...
<p class="rpt-text">この「外からの印象」と「内側の状態」のギャップが、このタイプの恋愛の出発点です。相手はあなたに魅力と自信を感じていますが、あなた自身の内側は確認の渇望でいっぱいになっています。このズレが後に大きな摩擦を生む種になります。</p>
`,

deepening: `
<p class="rpt-text">関係が深まるにつれ、あなたの中で起きることを丁寧に見ていきましょう。多くのロマンハンタータイプの人が「関係が深まるほど不安が増える」という逆説を経験します。愛されていると分かるほど、次の確認が必要になる——この循環の構造を理解することが重要です。</p>

<span class="rpt-label">深化フェーズで何が起きているか</span>

<p class="rpt-text">関係の初期は「まだ確認できていない」という状態なので、動くことに迷いがありません。しかし関係が深まり、「この人は自分を好きだ」という確信が一度得られると、<strong>今度は「この確信を失いたくない」という恐怖</strong>が生まれます。愛の確認から、愛の喪失への恐怖へと——不安の形が変わるのです。</p>
...
<div class="rpt-highlight">この悲劇の本質は、「相手の冷却→確認行動」という順序ではないことです。多くの場合、「確認行動→相手の冷却」という順序で起きています。あなたが恐れていた結果を、あなた自身が引き寄せているのです。</div>

<p class="rpt-text">これはあなたが悪いということではありません。このパターンは意識して変えない限り、続いていきます。しかし、気づいた今この瞬間から変えられます。</p>
`,
...
<p class="rpt-text">多くのロマンハンタータイプの人が、恋愛で追い求めているのは「愛の証明」です。相手の言葉、行動、反応——これらを通じて「自分は愛されている」という確信を得ようとします。しかしここに深刻な逆説があります。<strong>確認によって得られる安心は、一時的なものです。</strong>確認できた瞬間に安心するのではなく、次の確認が必要になるサイクルに入ってしまいます。</p>
...
<p class="rpt-text">この違いは大きいです。前者は相手を試すような圧力になりますが、後者はあなたの内側を見せることで、相手との信頼を深めます。脆弱さを見せることが、実は最も強力な絆の作り方です。</p>

<span class="rpt-label">戦略4：自分の時間を意図的に豊かにする</span>
<p class="rpt-text">恋愛以外に夢中になれるものを持つこと。これはパートナーへの依存度を下げるだけでなく、あなた自身が「自分の人生を生きている」という感覚を与えます。その感覚こそが「確認しなくても大丈夫」という内側の安定を少しずつ育てていきます。</p>
...
<p class="rpt-text">ストラテジストタイプの人にとって、恋愛における「不確実性」は単なる不便ではなく、<strong>脅威として感じられます</strong>。予測できない相手、一貫性のない言動、関係の方向性が曖昧な状態——これらは、あなたの安心システムに直接ダメージを与えます。だからこそ、関係を「設計」し「管理」することで安心を確保しようとするのです。</p>
...
<p class="rpt-text">一つ注意しておきたいことがあります。あなたの「信頼の評価プロセス」は精度が高いですが、<strong>「評価している間」は相手に冷たく見えることがあります</strong>。内側では深く関心を持っているのに、表面は慎重で距離があるように映る——このギャップが、せっかく良い相手との関係を進展させる前に終わらせてしまうことがあります。</p>
`,
...
trigger: `
<p class="rpt-text">あなたの関係が危うくなるとき、必ず<strong>「想定外＋信頼への疑問」</strong>の組み合わせが先に来ています。どちらか一方なら持ちこたえられますが、両方が重なった瞬間に、あなたの内側で関係の再評価が始まります。</p>
...
<ul class="rpt-step-list">
  ...
  <li class="rpt-step"><span class="rpt-step-num">03</span><div><div class="rpt-step-title">感情温度の急低下</div><div class="rpt-step-desc">信頼スコアが一定を下回ると、感情が急速に冷えます。外から見ると「突然冷たくなった」ように見えますが、あなたの内側では長い評価プロセスの結果です。</div></div></li>
...
<p class="rpt-text">しかし、安全をコントロールによって得ようとしたとき、そこには決して埋まらない穴があります。コントロールが完璧でない限り安心できないとすれば、それは<strong>「完璧なコントロール」という実現不可能な目標</strong>を追い続けることになります。相手は生身の人間であり、あなたの設計通りには動きません。</p>
...
<p class="rpt-text">意識的に「今日は相手に全部決めてもらう」という体験を作ってください。デートの場所でも、夕食のメニューでも構いません。コントロールを手放すことへの耐性は、<strong>小さな練習の積み重ねでしか育ちません</strong>。最初は強い不安を感じますが、それが通過点であることを知っておいてください。</p>
...
<div class="rpt-note"><span class="rpt-note-icon">✦</span><p class="rpt-note-text">あなたの信頼性と一貫性は、相手にとって何にも代えがたい安心感を提供します。それはあなたがすでに持っている最大の魅力です。コントロールを少し緩めたとき、その魅力はさらに深く相手に届きます。</p></div>
`,
},
...
<p class="rpt-text">このタイプの積極性は、Type 1と似ているように見えますが、動機が全く異なります。Type 1は愛を確かめるために動きます。Type 3（あなた）は<strong>「衝動に正直に生きること」が自分自身であるから動く</strong>のです。好意を持った瞬間に考える前に動いている——この即時性こそが、あなたの本質的なスタイルです。</p>
...
<p class="rpt-text">裏を返すと、最初から管理しようとする人、予定や行動に口を出す人、あなたの自由なリズムを「おかしい」と感じさせる人には、本能的に警戒心が働きます。これは意識的な判断ではなく、<strong>自己防衛の本能</strong>です。過去に「自分らしくいられなかった」経験が、このセンサーを磨き上げてきました。</p>
...
deepening: `
<p class="rpt-text">チャレンジャータイプにとって、関係の深化フェーズは最も複雑なフェーズです。深まりたいという欲求と、縛られることへの恐怖が同時に大きくなるからです。</p>
...
<p class="rpt-text">ここで起きる心理的変化が重要です。相手への感情は本物で変わっていないのに、「この関係では自分でいられない」という感覚が少しずつ生まれます。この感覚は論理的な判断ではなく、<u>本能的な防衛反応</u>です。感情のスイッチが切れる感覚——これを多くのチャレンジャータイプが経験します。</p>
...
<p class="rpt-text">もう一つ、このタイプが見落としがちなことがあります。<strong>あなたの感情が「深まりたい」と「逃げたい」を同時に感じているとき</strong>、その感情はあなたに何かを伝えようとしています。それは「この人と深まるのが怖い」というシグナルかもしれませんが、「深まる方向へ一歩踏み出せる力がある」という証拠でもあります。</p>
`,
...
<div class="rpt-note"><span class="rpt-note-icon">✦</span><p class="rpt-note-text">あなたの衝動性と正直さは、他の誰も持っていない特別な魅力です。「深まっても自分でいられる」という体験を一度すると、それがあなたの恋愛観を根本から変えます。その体験は、踏み出してみることでしか得られません。</p></div>
`,
},
...
<p class="rpt-text">このタイプが「尽くす」のは計算でも戦略でもありません。<strong>本当に相手のために動きたいという純粋な欲求</strong>から来ています。しかしその欲求の背景には、「尽くすことをやめたら、自分は愛される理由を失う」という深い恐怖が潜んでいることがあります。この恐怖は意識に上りにくいため、気づかないまま「尽くすこと」が止まらなくなっていきます。</p>
...
<p class="rpt-text">もう一つ重要なことがあります。尽くしすぎは、時に相手に<strong>「罪悪感」をもたらします</strong>。「こんなにしてもらっているのに、自分は十分に返せていない」という感覚が相手に積み重なると、関係への重さを感じ始めます。あなたの愛情が深いほど、相手に「返せない負債」を感じさせてしまうことがあるのです。</p>

<div class="rpt-highlight">深化フェーズで最も重要なシフト：「尽くす量を増やすこと」ではなく「あなた自身の欲求を言語化すること」が、関係を深める最速の方法です。</div>
`,

trigger: `
<p class="rpt-text">エンパスタイプの関係が崩れる前には、<strong>「見えない積み重ね」というプロセス</strong>が必ずあります。小さな「気づいてもらえなかった」が積み重なり、ある日突然の感情爆発か、静かな撤退として現れます。</p>
...
<p class="rpt-text">「何でもいいよ」が口癖なら、今日から一つ変えてください。何かを聞かれたとき、最初の反応で「私は〇〇がいい」と言う練習をしてください。些細なことから始めていいです。</p>
...
<p class="rpt-text">全力で尽くすのが自然なあなたですが、7割で留めてみてください。残りの3割をどうするかを相手が考える余地が生まれます。自発的に動いてくれる相手なら関係は対等に近づき、動かない相手なら、それもあなたへの大切な情報です。</p>
